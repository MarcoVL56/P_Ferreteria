...
public class JF_ReporteProducto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        PanelMenuRP = new javax.swing.JPanel();
        ...
        PanelMenuRP.setBackground(new java.awt.Color(204, 204, 204));
        PanelMenuRP.setForeground(new java.awt.Color(255, 255, 255));
        PanelMenuRP.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        ...
        PanelMenuRP.add(BtnMenu, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 590, 150, 30));
        ...
        PanelMenuRP.add(BtnFiltrarF, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 380, 150, -1));
        ...
        PanelMenuRP.add(BtnVentas, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 300, 150, -1));
        ...
        PanelMenuRP.add(BtnProforma, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 220, 150, -1));
        ...
        PanelMenuRP.add(BtnIRegistrarCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 150, 30));

        jPanel1.add(PanelMenuRP, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, 190, 660));
    ...
    private void btnSubMenuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSubMenuMouseClicked
        int posicion = PanelMenuRP.getX();
        if (posicion > -1) {
            Animacion.Animacion.mover_izquierda(0, -264, 2, 2, PanelMenuRP);
        } else {
            Animacion.Animacion.mover_derecha(-264, 0, 2, 2, PanelMenuRP);
        }
    ...
    private javax.swing.JPanel PanelMenuRP;
