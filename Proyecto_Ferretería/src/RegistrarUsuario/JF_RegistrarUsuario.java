...
public class JF_RegistrarUsuario extends javax.swing.JFrame {
    ...
    /**
     * Creates new form JF_RegistrarUsuario
     */
    ...
    private void initComponents() {
        ...
        PanelMenuU.setBackground(new java.awt.Color(204, 204, 204));
        PanelMenuU.setForeground(new java.awt.Color(255, 255, 255));
        PanelMenuU.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        ...
        PanelMenuU.add(BtnFiltrarFactura, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 380, -1, -1));
        ...
        PanelMenuU.add(BtnRegistrarCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 130, -1, -1));
        ...
        PanelMenuU.add(BtnProforma, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 210, -1, -1));
        ...
        PanelMenuU.add(BtnVentas, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 300, -1, -1));
        ...
        PanelMenuU.add(btnMenú, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 470, 150, 30));

        jPanel1.add(PanelMenuU, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, 190, 660));
    ...
    private void btnSubMenuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSubMenuMouseClicked
        int posicion = PanelMenuU.getX();
        if (posicion > -1) {
            Animacion.Animacion.mover_izquierda(0, -264, 2, 2, PanelMenuU);
        } else {
            Animacion.Animacion.mover_derecha(-264, 0, 2, 2, PanelMenuU);
        }
